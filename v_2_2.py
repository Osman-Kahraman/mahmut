...
{}
    ...
    v_2_2
₺-
+ Dışarıdan .txt dosyasını içe aktarma özelliği getirildi. Nasıl kullanacağını öğrenmek istersen Yardım/Komutlar bölümünden bakabilirsin. 
₺-
19.08.2021 Perşembe 19:43
₺+                  """, assets = False
                    )
...
₺+                  """.format(dir = str(list(self.words.keys())[1:]).replace(", ", "\n").lstrip("[").rstrip("]"))
                ...
                try: 
                    with open(PATH, "r", encoding = "utf-8") as file:
                        ...
                        self.console_text("{} tane kelime eklendi.".format(len(words)), assets = False)

                        del eng_word, tur_word, words
                except FileNotFoundError:
