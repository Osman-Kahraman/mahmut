...
{}
    ...
    v_2_7
₺-
+ Kelime ipucu sistemiyle ilgili hata düzeltildi.
+ Geri bildirim yazıları ile ilgili düzeltme eklendi.
+ Görsel dosya formatında (.png ya da .jpg) dışa aktarma bölümünde boyut ayarlaması yapıldı.
₺-
15.10.2021 Cuma 22:52
₺+                  """, assets = False
                    )
