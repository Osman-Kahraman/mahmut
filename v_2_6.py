...
{}
    ...
    v_2_6
₺-
+ Rastgele kelime sorma sistemindeki problem çözüldü.
+ Alt + 3 kısayoluyla ilgili sorun giderildi.
+ Kelime grubunu dışarı aktarmada kullanılan ".png", ".jpg" formatlarında oluşan encoding sorunu çözüldü.
₺-
13.09.2021 Pazartesi 21:51
₺+                  """, assets = False
                    )
