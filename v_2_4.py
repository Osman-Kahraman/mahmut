...
{}
    ...
    v_2_4
₺-
+ Konsol daha da optimize hale getirildi.
+ Kelimeleri içe aktarırken oluşan çökmeler giderildi.
+ Yeni Drag&Drop özelliği "içe aktar" komutuyla birlikte çalışır hale getirildi. Sadece yapman gereken, "1100 civarı" kelime içeren dosyanı yazı alanına bırakman olacak.
+ Kelime çalışma bölümü haricinde Alt + 3 tuş basımında oluşan çökme düzeltildi.
₺-
29.08.2021 Pazar 02:21
₺+                  """, assets = False
                    )
                ...
                try: 
                    with open(PATH, "r", encoding = "utf-8") as file:
                        ...
                        for word in words:
                            ...
                            self.words["idle"].update({eng_word: tur_word})
